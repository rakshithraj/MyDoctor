...
import com.app.mydoctor.Adapter.SpecialitiesAdapter;
...
import com.app.mydoctor.dao.SpecialitrsiesInfoList;
...
public final class SpecialitiesFragement extends Fragment implements ServerResponse, AdapterInterface {
    private static final String KEY_CONTENT = "SpecialitiesFragement:Content";
    RecyclerView mRecyclerView;
    //ProgressBar progressBar;
    Context context;
    ArrayList<SpecialitrsiesInfo> myDataset = new ArrayList<SpecialitrsiesInfo>();
    SpecialitiesAdapter mAdapter;
    private Handler handler;
    SpecialitrsiesInfoList newsDetailInfoList;
    View view;
    ;
    String url;
    String dep = "";
    ...
    public static SpecialitiesFragement newInstance() {
        SpecialitiesFragement fragment = new SpecialitiesFragement();
        return fragment;
    }
...
*/
    ...
    private void initialize() {
        ...
        //dumy dat
        SpecialitrsiesInfo specialitrsiesInfo;
        specialitrsiesInfo=new SpecialitrsiesInfo();
        specialitrsiesInfo.setName("PEDIATRICS");
        myDataset.add(specialitrsiesInfo);
        specialitrsiesInfo=new SpecialitrsiesInfo();
        specialitrsiesInfo.setName("PEDIATRICS");
        myDataset.add(specialitrsiesInfo);
        specialitrsiesInfo=new SpecialitrsiesInfo();
        ...
        mAdapter = new SpecialitiesAdapter(myDataset, this);
    ...
    public void onServerResponse(String result) {
        ...
        if (result != null) {
            ...
            try {
                newsDetailInfoList = gson.fromJson(result, SpecialitrsiesInfoList.class);
